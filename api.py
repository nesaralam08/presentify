...
def enroll():
    ...
    if file and file.filename != '':
        ...
        image_path = os.path.join(app.config['Image_db'], Aadhar_No+file_extension)
    ...
    cursor = conn.cursor()
    cursor.execute('''
        INSERT INTO data (name, Aadhar_No, dob, gender,image_path, face_encoding)
        VALUES (%s, %s, %s, %s, %s, %s, %s)
    ''', (name, Aadhar_No, dob, gender,image_path, face_encoding_str))
    conn.commit()
    cursor.close()
    conn.close()
